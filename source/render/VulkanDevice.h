...
namespace vk
{
	...
	public:
		...
		Device(VkPhysicalDevice physicalDevice, uint32_t graphicsFamilyIndex, uint32_t presentFamilyIndex)
		{
			this->physicalDevice = physicalDevice;
			queueFamilyIndices.graphics = graphicsFamilyIndex;
			queueFamilyIndices.present = presentFamilyIndex;
