...
namespace vk
{
	namespace initializers
	{
		...
		inline VkDescriptorSetLayoutBinding DescriptorSetLayoutBinding(VkDescriptorType type, VkShaderStageFlags stateFlags, uint32_t binding, uint32_t count = 1)
		{
		...
		inline VkPipelineLayoutCreateInfo PipelineLayoutCreateInfo(const VkDescriptorSetLayout* pSetLayouts, uint32_t setLayoutCount)
		{
		...
		inline VkPipelineRasterizationStateCreateInfo PipelineRasterizationStateCreateInfo(VkPolygonMode polygonMode, VkCullModeFlags cullMode, VkFrontFace frontFace, VkPipelineRasterizationStateCreateFlags flags)
		{
		...
		inline VkPipelineViewportStateCreateInfo PipelineViewportStateCreateInfo(uint32_t viewportCount, uint32_t scissorCount, VkPipelineViewportStateCreateFlags flags)
		{
		...
		inline VkPipelineMultisampleStateCreateInfo PipelineMultisampleStateCreateInfo(VkSampleCountFlagBits rasterizationSamples, VkPipelineMultisampleStateCreateFlags flags)
		{
		...
		inline VkPipelineDynamicStateCreateInfo PipelineDynamicStateCreateInfo(const VkDynamicState* pDynamicState, uint32_t dynamicStateCount, VkPipelineDynamicStateCreateFlags flags)
		{
		...
		inline VkGraphicsPipelineCreateInfo GraphicsPipelineCreateInfo(VkPipelineLayout layout, VkRenderPass renderPass, VkPipelineCreateFlags flags)
		{
		...
		inline VkComputePipelineCreateInfo ComputePipelineCreateInfo(VkPipelineLayout layout, VkPipelineCreateFlags flags)
		{
		...
		inline VkPushConstantRange PushConstantRange(VkShaderStageFlags stateFlags, uint32_t size, uint32_t offset)
		{
		...
		inline VkSpecializationMapEntry SpecializationMapEntry(uint32_t constantId, uint32_t size, uint32_t offset)
		{
		...
		inline VkSpecializationInfo SpecializationInfo(uint32_t mapEntryCount, const VkSpecializationMapEntry* pMapEntries, size_t dataSize, const void* pData)
		{
