...
std::ostream& dump_html_VkRenderPassInputAttachmentAspectCreateInfoKHR(const VkRenderPassInputAttachmentAspectCreateInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkPhysicalDevicePointClippingPropertiesKHR(const VkPhysicalDevicePointClippingPropertiesKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkInputAttachmentAspectReferenceKHR(const VkInputAttachmentAspectReferenceKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkImageViewUsageCreateInfoKHR(const VkImageViewUsageCreateInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkPipelineTessellationDomainOriginStateCreateInfoKHR(const VkPipelineTessellationDomainOriginStateCreateInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkBindBufferMemoryDeviceGroupInfoKHX(const VkBindBufferMemoryDeviceGroupInfoKHX& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkSamplerYcbcrConversionInfoKHR(const VkSamplerYcbcrConversionInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkBindImageMemoryDeviceGroupInfoKHX(const VkBindImageMemoryDeviceGroupInfoKHX& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkBindImagePlaneMemoryInfoKHR(const VkBindImagePlaneMemoryInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkImagePlaneMemoryRequirementsInfoKHR(const VkImagePlaneMemoryRequirementsInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkPhysicalDeviceSamplerYcbcrConversionFeaturesKHR(const VkPhysicalDeviceSamplerYcbcrConversionFeaturesKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkSamplerYcbcrConversionImageFormatPropertiesKHR(const VkSamplerYcbcrConversionImageFormatPropertiesKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkSamplerYcbcrConversionCreateInfoKHR(const VkSamplerYcbcrConversionCreateInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkBindBufferMemoryInfoKHR(const VkBindBufferMemoryInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkBindImageMemoryInfoKHR(const VkBindImageMemoryInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
inline std::ostream& dump_html_VkSamplerYcbcrConversionKHR(const VkSamplerYcbcrConversionKHR object, const ApiDumpSettings& settings, int indents)
{
    settings.stream() << "<div class='val'>";
    if(settings.showAddress())
        settings.stream() << object;
...
std::ostream& dump_html_VkSamplerYcbcrRangeKHR(VkSamplerYcbcrRangeKHR object, const ApiDumpSettings& settings, int indents)
{
    settings.stream() << "<div class='val'>";
    switch((int64_t) object)
    {
    case 0:
        settings.stream() << "VK_SAMPLER_YCBCR_RANGE_ITU_FULL_KHR (";
        break;
    case 1:
        settings.stream() << "VK_SAMPLER_YCBCR_RANGE_ITU_NARROW_KHR (";
        break;
    default:
        settings.stream() << "UNKNOWN (";
    }
...
std::ostream& dump_html_VkChromaLocationKHR(VkChromaLocationKHR object, const ApiDumpSettings& settings, int indents)
{
    settings.stream() << "<div class='val'>";
    switch((int64_t) object)
    {
    case 0:
        settings.stream() << "VK_CHROMA_LOCATION_COSITED_EVEN_KHR (";
        break;
    case 1:
        settings.stream() << "VK_CHROMA_LOCATION_MIDPOINT_KHR (";
        break;
    default:
        settings.stream() << "UNKNOWN (";
    }
...
std::ostream& dump_html_VkPointClippingBehaviorKHR(VkPointClippingBehaviorKHR object, const ApiDumpSettings& settings, int indents)
{
    settings.stream() << "<div class='val'>";
    switch((int64_t) object)
    {
    case 0:
        settings.stream() << "VK_POINT_CLIPPING_BEHAVIOR_ALL_CLIP_PLANES_KHR (";
        break;
    case 1:
        settings.stream() << "VK_POINT_CLIPPING_BEHAVIOR_USER_CLIP_PLANES_ONLY_KHR (";
        break;
    default:
        settings.stream() << "UNKNOWN (";
    }
...
std::ostream& dump_html_VkTessellationDomainOriginKHR(VkTessellationDomainOriginKHR object, const ApiDumpSettings& settings, int indents)
{
    settings.stream() << "<div class='val'>";
    switch((int64_t) object)
    {
    case 0:
        settings.stream() << "VK_TESSELLATION_DOMAIN_ORIGIN_UPPER_LEFT_KHR (";
        break;
    case 1:
        settings.stream() << "VK_TESSELLATION_DOMAIN_ORIGIN_LOWER_LEFT_KHR (";
        break;
    default:
        settings.stream() << "UNKNOWN (";
    }
...
std::ostream& dump_html_VkSamplerYcbcrModelConversionKHR(VkSamplerYcbcrModelConversionKHR object, const ApiDumpSettings& settings, int indents)
{
    settings.stream() << "<div class='val'>";
    switch((int64_t) object)
    {
    case 0:
        settings.stream() << "VK_SAMPLER_YCBCR_MODEL_CONVERSION_RGB_IDENTITY_KHR (";
        break;
    case 1:
        settings.stream() << "VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_IDENTITY_KHR (";
        break;
    case 2:
        settings.stream() << "VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_709_KHR (";
        break;
    case 3:
        settings.stream() << "VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_601_KHR (";
        break;
    case 4:
        settings.stream() << "VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_2020_KHR (";
        break;
    default:
        settings.stream() << "UNKNOWN (";
    }
...
std::ostream& dump_html_VkFormatFeatureFlagBits(VkFormatFeatureFlagBits object, const ApiDumpSettings& settings, int indents)
{
    ...
    if(object & 131072)
        is_first = dump_html_bitmaskOption("VK_FORMAT_FEATURE_MIDPOINT_CHROMA_SAMPLES_BIT_KHR", settings.stream(), is_first);
    if(object & 262144)
        is_first = dump_html_bitmaskOption("VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT_KHR", settings.stream(), is_first);
    if(object & 524288)
        is_first = dump_html_bitmaskOption("VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT_KHR", settings.stream(), is_first);
    if(object & 1048576)
        is_first = dump_html_bitmaskOption("VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT_KHR", settings.stream(), is_first);
    if(object & 2097152)
        is_first = dump_html_bitmaskOption("VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT_KHR", settings.stream(), is_first);
    if(object & 4194304)
        is_first = dump_html_bitmaskOption("VK_FORMAT_FEATURE_DISJOINT_BIT_KHR", settings.stream(), is_first);
    if(object & 8388608)
        is_first = dump_html_bitmaskOption("VK_FORMAT_FEATURE_COSITED_CHROMA_SAMPLES_BIT_KHR", settings.stream(), is_first);
    if(!is_first)
        settings.stream() << ")";
    return settings.stream() << "</div></summary>";
}
...
std::ostream& dump_html_VkImageCreateFlagBits(VkImageCreateFlagBits object, const ApiDumpSettings& settings, int indents)
{
    ...
    if(object & 128)
        is_first = dump_html_bitmaskOption("VK_IMAGE_CREATE_BLOCK_TEXEL_VIEW_COMPATIBLE_BIT_KHR", settings.stream(), is_first);
    if(object & 256)
        is_first = dump_html_bitmaskOption("VK_IMAGE_CREATE_EXTENDED_USAGE_BIT_KHR", settings.stream(), is_first);
    if(object & 4096)
        is_first = dump_html_bitmaskOption("VK_IMAGE_CREATE_SAMPLE_LOCATIONS_COMPATIBLE_DEPTH_BIT_EXT", settings.stream(), is_first);
    if(object & 512)
        is_first = dump_html_bitmaskOption("VK_IMAGE_CREATE_DISJOINT_BIT_KHR", settings.stream(), is_first);
    if(object & 1024)
        is_first = dump_html_bitmaskOption("VK_IMAGE_CREATE_ALIAS_BIT_KHR", settings.stream(), is_first);
    if(!is_first)
        settings.stream() << ")";
    return settings.stream() << "</div></summary>";
}
...
std::ostream& dump_html_VkImageAspectFlagBits(VkImageAspectFlagBits object, const ApiDumpSettings& settings, int indents)
{
    ...
    if(object & 16)
        is_first = dump_html_bitmaskOption("VK_IMAGE_ASPECT_PLANE_0_BIT_KHR", settings.stream(), is_first);
    if(object & 32)
        is_first = dump_html_bitmaskOption("VK_IMAGE_ASPECT_PLANE_1_BIT_KHR", settings.stream(), is_first);
    if(object & 64)
        is_first = dump_html_bitmaskOption("VK_IMAGE_ASPECT_PLANE_2_BIT_KHR", settings.stream(), is_first);
    if(!is_first)
        settings.stream() << ")";
    return settings.stream() << "</div></summary>";
}
...
std::ostream& dump_html_VkRenderPassInputAttachmentAspectCreateInfoKHR(const VkRenderPassInputAttachmentAspectCreateInfoKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_html_array<const VkInputAttachmentAspectReferenceKHR>(object.pAspectReferences, object.aspectReferenceCount, settings, "const VkInputAttachmentAspectReferenceKHR*", "const VkInputAttachmentAspectReferenceKHR", "pAspectReferences", indents + 1, dump_html_VkInputAttachmentAspectReferenceKHR);
    return settings.stream();
}
std::ostream& dump_html_VkPhysicalDeviceFeatures2KHR(const VkPhysicalDeviceFeatures2KHR& object, const ApiDumpSettings& settings, int indents)
{
...
std::ostream& dump_html_VkPhysicalDevicePointClippingPropertiesKHR(const VkPhysicalDevicePointClippingPropertiesKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_html_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_html_VkStructureType);
    dump_html_value<const void*>(object.pNext, settings, "void*", "pNext", indents + 1, dump_html_void);
    dump_html_value<const VkPointClippingBehaviorKHR>(object.pointClippingBehavior, settings, "VkPointClippingBehaviorKHR", "pointClippingBehavior", indents + 1, dump_html_VkPointClippingBehaviorKHR);
    return settings.stream();
}
#if defined(VK_USE_PLATFORM_WIN32_KHR)
std::ostream& dump_html_VkMemoryGetWin32HandleInfoKHR(const VkMemoryGetWin32HandleInfoKHR& object, const ApiDumpSettings& settings, int indents)
...
std::ostream& dump_html_VkPipelineTessellationDomainOriginStateCreateInfoKHR(const VkPipelineTessellationDomainOriginStateCreateInfoKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_html_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_html_VkStructureType);
    dump_html_value<const void*>(object.pNext, settings, "const void*", "pNext", indents + 1, dump_html_void);
    dump_html_value<const VkTessellationDomainOriginKHR>(object.domainOrigin, settings, "VkTessellationDomainOriginKHR", "domainOrigin", indents + 1, dump_html_VkTessellationDomainOriginKHR);
    return settings.stream();
}
std::ostream& dump_html_VkQueueFamilyProperties2KHR(const VkQueueFamilyProperties2KHR& object, const ApiDumpSettings& settings, int indents)
{
...
std::ostream& dump_html_VkSamplerYcbcrConversionInfoKHR(const VkSamplerYcbcrConversionInfoKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_html_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_html_VkStructureType);
    dump_html_value<const void*>(object.pNext, settings, "const void*", "pNext", indents + 1, dump_html_void);
    dump_html_value<const VkSamplerYcbcrConversionKHR>(object.conversion, settings, "VkSamplerYcbcrConversionKHR", "conversion", indents + 1, dump_html_VkSamplerYcbcrConversionKHR);
    return settings.stream();
}
std::ostream& dump_html_VkShaderModuleValidationCacheCreateInfoEXT(const VkShaderModuleValidationCacheCreateInfoEXT& object, const ApiDumpSettings& settings, int indents)
{
...
std::ostream& dump_html_VkSamplerYcbcrConversionCreateInfoKHR(const VkSamplerYcbcrConversionCreateInfoKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_html_value<const void*>(object.pNext, settings, "const void*", "pNext", indents + 1, dump_html_void);
    dump_html_value<const VkFormat>(object.format, settings, "VkFormat", "format", indents + 1, dump_html_VkFormat);
    dump_html_value<const VkSamplerYcbcrModelConversionKHR>(object.ycbcrModel, settings, "VkSamplerYcbcrModelConversionKHR", "ycbcrModel", indents + 1, dump_html_VkSamplerYcbcrModelConversionKHR);
    dump_html_value<const VkSamplerYcbcrRangeKHR>(object.ycbcrRange, settings, "VkSamplerYcbcrRangeKHR", "ycbcrRange", indents + 1, dump_html_VkSamplerYcbcrRangeKHR);
    dump_html_value<const VkComponentMapping>(object.components, settings, "VkComponentMapping", "components", indents + 1, dump_html_VkComponentMapping);
    dump_html_value<const VkChromaLocationKHR>(object.xChromaOffset, settings, "VkChromaLocationKHR", "xChromaOffset", indents + 1, dump_html_VkChromaLocationKHR);
    dump_html_value<const VkChromaLocationKHR>(object.yChromaOffset, settings, "VkChromaLocationKHR", "yChromaOffset", indents + 1, dump_html_VkChromaLocationKHR);
...
std::ostream& dump_html_vkGetMemoryHostPointerPropertiesEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkExternalMemoryHandleTypeFlagBitsKHR handleType, const void* pHostPointer, VkMemoryHostPointerPropertiesEXT* pMemoryHostPointerProperties)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
...
std::ostream& dump_html_vkBindImageMemory2KHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t bindInfoCount, const VkBindImageMemoryInfoKHR* pBindInfos)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
    ...
    if(settings.showParams())
    {
        dump_html_value<const VkDevice>(device, settings, "VkDevice", "device", 1, dump_html_VkDevice);
        dump_html_value<const uint32_t>(bindInfoCount, settings, "uint32_t", "bindInfoCount", 1, dump_html_uint32_t);
        dump_html_array<const VkBindImageMemoryInfoKHR>(pBindInfos, bindInfoCount, settings, "const VkBindImageMemoryInfoKHR*", "const VkBindImageMemoryInfoKHR", "pBindInfos", 1, dump_html_VkBindImageMemoryInfoKHR);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";

    return settings.stream() << "</details>";
}
std::ostream& dump_html_vkGetShaderInfoAMD(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkPipeline pipeline, VkShaderStageFlagBits shaderStage, VkShaderInfoTypeAMD infoType, size_t* pInfoSize, void* pInfo)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
...
std::ostream& dump_html_vkCreateValidationCacheEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkValidationCacheCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkValidationCacheEXT* pValidationCache)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
...
std::ostream& dump_html_vkGetValidationCacheDataEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkValidationCacheEXT validationCache, size_t* pDataSize, void* pData)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
...
std::ostream& dump_html_vkMergeValidationCachesEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkValidationCacheEXT dstCache, uint32_t srcCacheCount, const VkValidationCacheEXT* pSrcCaches)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
...
std::ostream& dump_html_vkCreateSamplerYcbcrConversionKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkSamplerYcbcrConversionCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSamplerYcbcrConversionKHR* pYcbcrConversion)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
    ...
    {
        dump_html_value<const VkDevice>(device, settings, "VkDevice", "device", 1, dump_html_VkDevice);
        dump_html_pointer<const VkSamplerYcbcrConversionCreateInfoKHR>(pCreateInfo, settings, "const VkSamplerYcbcrConversionCreateInfoKHR*", "pCreateInfo", 1, dump_html_VkSamplerYcbcrConversionCreateInfoKHR);
        dump_html_pointer<const VkAllocationCallbacks>(pAllocator, settings, "const VkAllocationCallbacks*", "pAllocator", 1, dump_html_VkAllocationCallbacks);
        dump_html_pointer<const VkSamplerYcbcrConversionKHR>(pYcbcrConversion, settings, "VkSamplerYcbcrConversionKHR*", "pYcbcrConversion", 1, dump_html_VkSamplerYcbcrConversionKHR);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
...
std::ostream& dump_html_vkBindBufferMemory2KHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t bindInfoCount, const VkBindBufferMemoryInfoKHR* pBindInfos)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
    ...
    if(settings.showParams())
    {
        dump_html_value<const VkDevice>(device, settings, "VkDevice", "device", 1, dump_html_VkDevice);
        dump_html_value<const uint32_t>(bindInfoCount, settings, "uint32_t", "bindInfoCount", 1, dump_html_uint32_t);
        dump_html_array<const VkBindBufferMemoryInfoKHR>(pBindInfos, bindInfoCount, settings, "const VkBindBufferMemoryInfoKHR*", "const VkBindBufferMemoryInfoKHR", "pBindInfos", 1, dump_html_VkBindBufferMemoryInfoKHR);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
...
std::ostream& dump_html_vkCmdSetSampleLocationsEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, const VkSampleLocationsInfoEXT* pSampleLocationsInfo)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
...
std::ostream& dump_html_vkGetPhysicalDeviceMultisamplePropertiesEXT(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, VkSampleCountFlagBits samples, VkMultisamplePropertiesEXT* pMultisampleProperties)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
...
std::ostream& dump_html_vkDestroyValidationCacheEXT(ApiDumpInstance& dump_inst, VkDevice device, VkValidationCacheEXT validationCache, const VkAllocationCallbacks* pAllocator)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
...
std::ostream& dump_html_vkDestroySamplerYcbcrConversionKHR(ApiDumpInstance& dump_inst, VkDevice device, VkSamplerYcbcrConversionKHR ycbcrConversion, const VkAllocationCallbacks* pAllocator)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
    ...
    {
        dump_html_value<const VkDevice>(device, settings, "VkDevice", "device", 1, dump_html_VkDevice);
        dump_html_value<const VkSamplerYcbcrConversionKHR>(ycbcrConversion, settings, "VkSamplerYcbcrConversionKHR", "ycbcrConversion", 1, dump_html_VkSamplerYcbcrConversionKHR);
        dump_html_pointer<const VkAllocationCallbacks>(pAllocator, settings, "const VkAllocationCallbacks*", "pAllocator", 1, dump_html_VkAllocationCallbacks);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
