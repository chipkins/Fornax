...
std::ostream& dump_text_VkPhysicalDevicePointClippingPropertiesKHR(const VkPhysicalDevicePointClippingPropertiesKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkRenderPassInputAttachmentAspectCreateInfoKHR(const VkRenderPassInputAttachmentAspectCreateInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkImageViewUsageCreateInfoKHR(const VkImageViewUsageCreateInfoKHR& object, const ApiDumpSettings& settings, int indents);
std::ostream& dump_text_VkInputAttachmentAspectReferenceKHR(const VkInputAttachmentAspectReferenceKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkPipelineTessellationDomainOriginStateCreateInfoKHR(const VkPipelineTessellationDomainOriginStateCreateInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkBindBufferMemoryDeviceGroupInfoKHX(const VkBindBufferMemoryDeviceGroupInfoKHX& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkSamplerYcbcrConversionInfoKHR(const VkSamplerYcbcrConversionInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkBindImageMemoryDeviceGroupInfoKHX(const VkBindImageMemoryDeviceGroupInfoKHX& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkBindImagePlaneMemoryInfoKHR(const VkBindImagePlaneMemoryInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkImagePlaneMemoryRequirementsInfoKHR(const VkImagePlaneMemoryRequirementsInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkPhysicalDeviceSamplerYcbcrConversionFeaturesKHR(const VkPhysicalDeviceSamplerYcbcrConversionFeaturesKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkSamplerYcbcrConversionImageFormatPropertiesKHR(const VkSamplerYcbcrConversionImageFormatPropertiesKHR& object, const ApiDumpSettings& settings, int indents);
...
#endif // VK_USE_PLATFORM_WIN32_KHR
std::ostream& dump_text_VkSamplerYcbcrConversionCreateInfoKHR(const VkSamplerYcbcrConversionCreateInfoKHR& object, const ApiDumpSettings& settings, int indents);
std::ostream& dump_text_VkBindImageMemoryInfoKHR(const VkBindImageMemoryInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkBindBufferMemoryInfoKHR(const VkBindBufferMemoryInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
inline std::ostream& dump_text_VkSamplerYcbcrConversionKHR(const VkSamplerYcbcrConversionKHR object, const ApiDumpSettings& settings, int indents)
{
    if(settings.showAddress())
        return settings.stream() << object;
    else
...
std::ostream& dump_text_VkSamplerYcbcrRangeKHR(VkSamplerYcbcrRangeKHR object, const ApiDumpSettings& settings, int indents)
{
    switch((int64_t) object)
    {
    case 0:
...
std::ostream& dump_text_VkSamplerYcbcrModelConversionKHR(VkSamplerYcbcrModelConversionKHR object, const ApiDumpSettings& settings, int indents)
{
    switch((int64_t) object)
    {
    case 0:
...
std::ostream& dump_text_VkChromaLocationKHR(VkChromaLocationKHR object, const ApiDumpSettings& settings, int indents)
{
    switch((int64_t) object)
    {
    case 0:
...
std::ostream& dump_text_VkPointClippingBehaviorKHR(VkPointClippingBehaviorKHR object, const ApiDumpSettings& settings, int indents)
{
    switch((int64_t) object)
    {
    case 0:
...
std::ostream& dump_text_VkTessellationDomainOriginKHR(VkTessellationDomainOriginKHR object, const ApiDumpSettings& settings, int indents)
{
    switch((int64_t) object)
    {
    case 0:
...
std::ostream& dump_text_VkFormatFeatureFlagBits(VkFormatFeatureFlagBits object, const ApiDumpSettings& settings, int indents)
{
    ...
    if(object & 131072)
        is_first = dump_text_bitmaskOption("VK_FORMAT_FEATURE_MIDPOINT_CHROMA_SAMPLES_BIT_KHR", settings.stream(), is_first);
    if(object & 262144)
        is_first = dump_text_bitmaskOption("VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT_KHR", settings.stream(), is_first);
    if(object & 524288)
        is_first = dump_text_bitmaskOption("VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT_KHR", settings.stream(), is_first);
    if(object & 1048576)
        is_first = dump_text_bitmaskOption("VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT_KHR", settings.stream(), is_first);
    if(object & 2097152)
        is_first = dump_text_bitmaskOption("VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT_KHR", settings.stream(), is_first);
    if(object & 4194304)
        is_first = dump_text_bitmaskOption("VK_FORMAT_FEATURE_DISJOINT_BIT_KHR", settings.stream(), is_first);
    if(object & 8388608)
        is_first = dump_text_bitmaskOption("VK_FORMAT_FEATURE_COSITED_CHROMA_SAMPLES_BIT_KHR", settings.stream(), is_first);
    if(!is_first)
        settings.stream() << ")";
    return settings.stream();
}
...
std::ostream& dump_text_VkImageCreateFlagBits(VkImageCreateFlagBits object, const ApiDumpSettings& settings, int indents)
{
    ...
    if(object & 128)
        is_first = dump_text_bitmaskOption("VK_IMAGE_CREATE_BLOCK_TEXEL_VIEW_COMPATIBLE_BIT_KHR", settings.stream(), is_first);
    if(object & 256)
        is_first = dump_text_bitmaskOption("VK_IMAGE_CREATE_EXTENDED_USAGE_BIT_KHR", settings.stream(), is_first);
    if(object & 4096)
        is_first = dump_text_bitmaskOption("VK_IMAGE_CREATE_SAMPLE_LOCATIONS_COMPATIBLE_DEPTH_BIT_EXT", settings.stream(), is_first);
    if(object & 512)
        is_first = dump_text_bitmaskOption("VK_IMAGE_CREATE_DISJOINT_BIT_KHR", settings.stream(), is_first);
    if(object & 1024)
        is_first = dump_text_bitmaskOption("VK_IMAGE_CREATE_ALIAS_BIT_KHR", settings.stream(), is_first);
    if(!is_first)
        settings.stream() << ")";
    return settings.stream();
}
...
std::ostream& dump_text_VkImageAspectFlagBits(VkImageAspectFlagBits object, const ApiDumpSettings& settings, int indents)
{
    ...
    if(object & 16)
        is_first = dump_text_bitmaskOption("VK_IMAGE_ASPECT_PLANE_0_BIT_KHR", settings.stream(), is_first);
    if(object & 32)
        is_first = dump_text_bitmaskOption("VK_IMAGE_ASPECT_PLANE_1_BIT_KHR", settings.stream(), is_first);
    if(object & 64)
        is_first = dump_text_bitmaskOption("VK_IMAGE_ASPECT_PLANE_2_BIT_KHR", settings.stream(), is_first);
    if(!is_first)
        settings.stream() << ")";
    return settings.stream();
}
...
std::ostream& dump_text_VkPhysicalDevicePointClippingPropertiesKHR(const VkPhysicalDevicePointClippingPropertiesKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_text_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_text_VkStructureType);
    dump_text_value<const void*>(object.pNext, settings, "void*", "pNext", indents + 1, dump_text_void);
    dump_text_value<const VkPointClippingBehaviorKHR>(object.pointClippingBehavior, settings, "VkPointClippingBehaviorKHR", "pointClippingBehavior", indents + 1, dump_text_VkPointClippingBehaviorKHR);
    return settings.stream();
}
#if defined(VK_USE_PLATFORM_WIN32_KHR)
std::ostream& dump_text_VkMemoryGetWin32HandleInfoKHR(const VkMemoryGetWin32HandleInfoKHR& object, const ApiDumpSettings& settings, int indents)
...
std::ostream& dump_text_VkRenderPassInputAttachmentAspectCreateInfoKHR(const VkRenderPassInputAttachmentAspectCreateInfoKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_text_array<const VkInputAttachmentAspectReferenceKHR>(object.pAspectReferences, object.aspectReferenceCount, settings, "const VkInputAttachmentAspectReferenceKHR*", "const VkInputAttachmentAspectReferenceKHR", "pAspectReferences", indents + 1, dump_text_VkInputAttachmentAspectReferenceKHR);
    return settings.stream();
}
#if defined(VK_USE_PLATFORM_IOS_MVK)
std::ostream& dump_text_VkIOSSurfaceCreateInfoMVK(const VkIOSSurfaceCreateInfoMVK& object, const ApiDumpSettings& settings, int indents)
...
std::ostream& dump_text_VkPipelineTessellationDomainOriginStateCreateInfoKHR(const VkPipelineTessellationDomainOriginStateCreateInfoKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_text_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_text_VkStructureType);
    dump_text_value<const void*>(object.pNext, settings, "const void*", "pNext", indents + 1, dump_text_void);
    dump_text_value<const VkTessellationDomainOriginKHR>(object.domainOrigin, settings, "VkTessellationDomainOriginKHR", "domainOrigin", indents + 1, dump_text_VkTessellationDomainOriginKHR);
    return settings.stream();
}
std::ostream& dump_text_VkMemoryGetFdInfoKHR(const VkMemoryGetFdInfoKHR& object, const ApiDumpSettings& settings, int indents)
{
...
std::ostream& dump_text_VkSamplerYcbcrConversionInfoKHR(const VkSamplerYcbcrConversionInfoKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_text_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_text_VkStructureType);
    dump_text_value<const void*>(object.pNext, settings, "const void*", "pNext", indents + 1, dump_text_void);
    dump_text_value<const VkSamplerYcbcrConversionKHR>(object.conversion, settings, "VkSamplerYcbcrConversionKHR", "conversion", indents + 1, dump_text_VkSamplerYcbcrConversionKHR);
    return settings.stream();
}
std::ostream& dump_text_VkSpecializationInfo(const VkSpecializationInfo& object, const ApiDumpSettings& settings, int indents)
{
...
std::ostream& dump_text_VkSamplerYcbcrConversionCreateInfoKHR(const VkSamplerYcbcrConversionCreateInfoKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_text_value<const void*>(object.pNext, settings, "const void*", "pNext", indents + 1, dump_text_void);
    dump_text_value<const VkFormat>(object.format, settings, "VkFormat", "format", indents + 1, dump_text_VkFormat);
    dump_text_value<const VkSamplerYcbcrModelConversionKHR>(object.ycbcrModel, settings, "VkSamplerYcbcrModelConversionKHR", "ycbcrModel", indents + 1, dump_text_VkSamplerYcbcrModelConversionKHR);
    dump_text_value<const VkSamplerYcbcrRangeKHR>(object.ycbcrRange, settings, "VkSamplerYcbcrRangeKHR", "ycbcrRange", indents + 1, dump_text_VkSamplerYcbcrRangeKHR);
    dump_text_value<const VkComponentMapping>(object.components, settings, "VkComponentMapping", "components", indents + 1, dump_text_VkComponentMapping);
    dump_text_value<const VkChromaLocationKHR>(object.xChromaOffset, settings, "VkChromaLocationKHR", "xChromaOffset", indents + 1, dump_text_VkChromaLocationKHR);
    dump_text_value<const VkChromaLocationKHR>(object.yChromaOffset, settings, "VkChromaLocationKHR", "yChromaOffset", indents + 1, dump_text_VkChromaLocationKHR);
...
#endif // VK_USE_PLATFORM_WIN32_KHR
std::ostream& dump_text_vkGetMemoryHostPointerPropertiesEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkExternalMemoryHandleTypeFlagBitsKHR handleType, const void* pHostPointer, VkMemoryHostPointerPropertiesEXT* pMemoryHostPointerProperties)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    settings.stream() << "Thread " << dump_inst.threadID() << ", Frame " << dump_inst.frameCount() << ":\n";
...
std::ostream& dump_text_vkBindImageMemory2KHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t bindInfoCount, const VkBindImageMemoryInfoKHR* pBindInfos)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    settings.stream() << "Thread " << dump_inst.threadID() << ", Frame " << dump_inst.frameCount() << ":\n";
    ...
    if(settings.showParams())
    {
        dump_text_value<const VkDevice>(device, settings, "VkDevice", "device", 1, dump_text_VkDevice);
        dump_text_value<const uint32_t>(bindInfoCount, settings, "uint32_t", "bindInfoCount", 1, dump_text_uint32_t);
        dump_text_array<const VkBindImageMemoryInfoKHR>(pBindInfos, bindInfoCount, settings, "const VkBindImageMemoryInfoKHR*", "const VkBindImageMemoryInfoKHR", "pBindInfos", 1, dump_text_VkBindImageMemoryInfoKHR);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
...
#endif // VK_USE_PLATFORM_WAYLAND_KHR
std::ostream& dump_text_vkCreateSamplerYcbcrConversionKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkSamplerYcbcrConversionCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSamplerYcbcrConversionKHR* pYcbcrConversion)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    settings.stream() << "Thread " << dump_inst.threadID() << ", Frame " << dump_inst.frameCount() << ":\n";
    ...
    {
        dump_text_value<const VkDevice>(device, settings, "VkDevice", "device", 1, dump_text_VkDevice);
        dump_text_pointer<const VkSamplerYcbcrConversionCreateInfoKHR>(pCreateInfo, settings, "const VkSamplerYcbcrConversionCreateInfoKHR*", "pCreateInfo", 1, dump_text_VkSamplerYcbcrConversionCreateInfoKHR);
        dump_text_pointer<const VkAllocationCallbacks>(pAllocator, settings, "const VkAllocationCallbacks*", "pAllocator", 1, dump_text_VkAllocationCallbacks);
        dump_text_pointer<const VkSamplerYcbcrConversionKHR>(pYcbcrConversion, settings, "VkSamplerYcbcrConversionKHR*", "pYcbcrConversion", 1, dump_text_VkSamplerYcbcrConversionKHR);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
...
std::ostream& dump_text_vkBindBufferMemory2KHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t bindInfoCount, const VkBindBufferMemoryInfoKHR* pBindInfos)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    settings.stream() << "Thread " << dump_inst.threadID() << ", Frame " << dump_inst.frameCount() << ":\n";
    ...
    if(settings.showParams())
    {
        dump_text_value<const VkDevice>(device, settings, "VkDevice", "device", 1, dump_text_VkDevice);
        dump_text_value<const uint32_t>(bindInfoCount, settings, "uint32_t", "bindInfoCount", 1, dump_text_uint32_t);
        dump_text_array<const VkBindBufferMemoryInfoKHR>(pBindInfos, bindInfoCount, settings, "const VkBindBufferMemoryInfoKHR*", "const VkBindBufferMemoryInfoKHR", "pBindInfos", 1, dump_text_VkBindBufferMemoryInfoKHR);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
...
std::ostream& dump_text_vkDestroySamplerYcbcrConversionKHR(ApiDumpInstance& dump_inst, VkDevice device, VkSamplerYcbcrConversionKHR ycbcrConversion, const VkAllocationCallbacks* pAllocator)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    settings.stream() << "Thread " << dump_inst.threadID() << ", Frame " << dump_inst.frameCount() << ":\n";
    ...
    {
        dump_text_value<const VkDevice>(device, settings, "VkDevice", "device", 1, dump_text_VkDevice);
        dump_text_value<const VkSamplerYcbcrConversionKHR>(ycbcrConversion, settings, "VkSamplerYcbcrConversionKHR", "ycbcrConversion", 1, dump_text_VkSamplerYcbcrConversionKHR);
        dump_text_pointer<const VkAllocationCallbacks>(pAllocator, settings, "const VkAllocationCallbacks*", "pAllocator", 1, dump_text_VkAllocationCallbacks);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
